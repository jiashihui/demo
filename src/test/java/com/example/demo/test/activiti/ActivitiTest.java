...
public class ActivitiTest {
    ...
    public void testCreateProcessEngine() {
        ...
        cfg.setJdbcUrl("jdbc:mysql://127.0.0.1:3306/test");
    ...
    public void testCreateProcessEngineByCfgXml() {
        ProcessEngineConfiguration cfg = ProcessEngineConfiguration.createProcessEngineConfigurationFromResource("bpmn/activiti.cfg.xml");
        ProcessEngine engine = cfg.buildProcessEngine();
    }
    ...
    public void deployProcess() {
        ...
        builder.addClasspathResource("bpmn/Process-1.bpmn");
        builder.deploy();
    }
